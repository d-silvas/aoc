...
struct NumberDigit {
    digit: u8,
    position: Position,
    adjacent_gear_positions: Vec<Position>,
}
...
impl NumberDigit {
    pub fn new(position: Position, all_chars: &Vec<Vec<char>>) -> Self {
        ...
        let adjacent_gear_positions: Vec<Position> =
            Self::get_adjacent_gear_positions(&all_chars, &position);
        NumberDigit {
            digit,
            position,
...
struct Number {
    ...
    // TODO: get the positions of adjacent gears
}
